          ...
          <>
            <ul className='navbar-list-desktop'>
              <li className='dropdown'>
                <span>{Auth.getUser().data.full_name.toUpperCase()}</span>
              ...
              <li>
                <a
                  href={Auth.getUser().data.resume_url}
                  target='_blank'
            ...
            >
              <li>
                <a href='/dasboard' target='_blank' rel='noopener noreferrer'>
                  {Auth.getUser().data.full_name}
                </a>
              </li>
              <li>
                <a
